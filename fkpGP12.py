...
def fkpGP12(t1, t2, t3, t4, t5, t6):
    T = np.eye(4)
    T = T.dot(dh_transform(t1, 0, 0.155, np.pi/2))
...
print('Should be: ' + str([0.895, 0, 0.814]))
...
print('Should be: ' + str([0, 0.895, 0.814]))
...
print('Should be: ' + str([0.155-0.200-0.614, 0, 0.640+0.100]))
...
print('Should be: ' + str([0.155-0.2, 0, 0.614+0.640+0.1]))
...
print('Should be: ' + str([0.795, 0, 0.914]))
...
print('Should be: ' + str([0.1, 0.155-0.614-0.640, -0.2]))
